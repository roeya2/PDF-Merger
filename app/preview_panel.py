...
from app.tooltip import Tooltip # Assuming Tooltip is in its own file
from app.pdf_document import PDFDocument # Assuming PDFDocument is in its own file
from app.background_task import BackgroundTask # Assuming BackgroundTask is in its own file

...
from ..utils.constants import (
    ...
    # New modern UI constants
    PRIMARY_COLOR, SURFACE_COLOR, TEXT_PRIMARY,
    ICON_SIZE_MEDIUM, FONT_SIZE_MD
)
from ..utils.utils import setup_application_logging
...
from ..ui.modern_style import get_style_manager, initialize_styles
from ..utils.icons import get_icon_manager
from ..utils.file_type_detector import get_file_type_detector
from ..managers.recent_folders_manager import initialize_recent_folders_manager
...
class PDFMergerApp:
    ...
    def __init__(self, root: tkdnd.TkinterDnD.Tk):
        ...
        # 4. Initialize Modern UI Systems
        self.style_manager = initialize_styles(self.root)
        self.icon_manager = get_icon_manager()
        self.file_detector = get_file_type_detector()
        self.error_handler = get_error_handler()
        self.recent_folders_manager = initialize_recent_folders_manager(self.config_manager)

        # 5. Initialize Manager Classes
        ...
        # 10. Initialize shared Tkinter variables
        ...
        # 11. Setup Modern Styles (already initialized in step 4)
        ...
        # 15. Start Background Task Queue Monitor
        self.root.after(TASK_QUEUE_CHECK_INTERVAL, self.app_core.check_task_queue)

        # 16. Set Window Close Protocol
        self.root.protocol("WM_DELETE_WINDOW", self._on_closing)

        # 17. Apply Saved Sash Positions (after panels are created)
    ...
    def _on_closing(self):
        ...
        try:
            ...
            try:
                ...
                sash_positions = {'upper_panedwindow': self.upper_panedwindow.sashpos(0)} if hasattr(self, 'upper_panedwindow') and self.upper_panedwindow.winfo_exists() else {}
